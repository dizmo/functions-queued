...
describe("queued", () => {
    it("should enqueue w/a deferred next & auto:[true]", () => {
        ...
        setTimeout(() => n_f0.should.equal(3), 250);
    });
    it("should enqueue w/a deferred next & auto:[true] w/2 functions", () => {
        ...
        setTimeout(() => n_f1.should.equal(6), 250);
    });
    it("should enqueue w/a deferred next & auto:[false]", () => {
        ...
        setTimeout(() => n_f2.should.equal(3), 250);
    });
});
describe("queued", () => {
    it("should enqueue w/o deferred next & auto:[true]", () => {
        ...
        setTimeout(() => n_f3.should.equal(3), 250);
    });
    it("should enqueue w/o deferred next & auto:[false]", () => {
        ...
        setTimeout(() => n_f4.should.equal(3), 250);
    });
});
describe("queued", () => {
...
describe("queued", () => {
    it("should enqueue w/a deferred promise & auto:[true]", () => {
        let n_f0 = 0;
        const f0 = queued(
            (number: number, next: Function) => {
                number.should.be.a("number");
    ...
    it("should enqueue w/a deferred promise & auto:[true] w/2 functions", () => {
        let n_f1 = 0;
        const f1 = queued.auto(true)(
            (next: Function) => {
                next.should.be.a("function");
    ...
    it("should enqueue w/a deferred promise & auto:[false]", () => {
        let n_f2 = 0;
        const f2 = queued.auto(false)((next: Function) => {
            next.should.be.a("function");
            return new Promise((resolve) => {
...
describe("queued", () => {
    it("should enqueue w/o deferred promise & auto:[true]", () => {
        let n_f3 = 0;
        const f3 = queued.auto(true)((next: Function) => {
            next.should.be.a("function");
            setTimeout(() => {
    ...
    it("should enqueue w/o deferred promise & auto:[false]", () => {
        let n_f4 = 0;
        const f4 = queued.auto(false)(() => {
            setTimeout(() => {
                n_f4 += 1; // i.e. *w/o* deferred next()
...
describe("queued", () => {
    it("should named enqueue:f5 w/a deferred promise & auto:[false]", () => {
        let n_f5 = 0;
        let n_f5a = 0;
        let n_f5b = 0;
        const f5a = queued.auto(false)(function f5(next: Function) {
    ...
    it("should named enqueue:f6 w/a deferred promise & auto:[false]", () => {
        let n_f6 = 0;
        let n_f6a = 0;
        let n_f6b = 0;
        const f6a = queued.auto(false)(function f6(next: Function) {
    ...
    it("should named enqueue:f7 w/a deferred promise & auto:[false, true]", () => {
        let n_f7 = 0;
        let n_f7a = 0;
        let n_f7b = 0;
        const f7a = queued.auto(false)(function f7(next: Function) {
    ...
    it("should named enqueue:f8 w/a deferred promise & auto:[true, false]", () => {
        let n_f8 = 0;
        let n_f8a = 0;
        let n_f8b = 0;
        const f8a = queued.auto(true)(function f8(next: Function) {
    ...
    it("should named enqueue:f9 w/a deferred promise & auto:[true, true]", () => {
        let n_f9 = 0;
        let n_f9a = 0;
        let n_f9b = 0;
        const f9a = queued.auto(true)(function f9(next: Function) {
